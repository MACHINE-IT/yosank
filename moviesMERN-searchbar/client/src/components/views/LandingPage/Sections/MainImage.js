        ...
        >
            <div>
                <div style={{ position: 'absolute', maxWidth: '500px', bottom: '2rem', marginLeft: '2rem' }} >
                    ...
                    <Button primary cursor="pointer" onClick={()=>{playTrailer()}} className="trailer_button">Play Trailer</Button>
                    {
                        open ? 
                        <div className="trailer_container">
                            <div className="trailer_item">
                                ...
                                <h1>{props.title}</h1>
                                <HighlightOffRoundedIcon className="close_btn" onClick={()=>{closePopup()}}/>
                                </div>
